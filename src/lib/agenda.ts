...
export const AGENDA: AgendaSession[] = [
  ...
  },
  {
    ...
    description:
      "Rotate through three hands-on stations: Claude for faculty, Claude Cowork for administrators & staff, and Gemini Notebook for students. Check in at each station to stamp your AI Learning Passport.",
    links: [
